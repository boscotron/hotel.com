 ...
 <section class="parallax-window" id="short" data-parallax="scroll" data-image-src="<?php echo RUTA_ACTUAL.BASE_TEMPLET; ?>img/sub_header_short_2.jpg" data-natural-width="1400" data-natural-height="350">
        <div id="subheader">
            <h1 class="jmy_web_div" data-page="TEMAZCAL" id="titulo_temazcal" data-editor="no">
                <?php $this->pnt('titulo_temazcal','TEMAZCAL'); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-md-offset-1">
                    <div class="room_desc_home">
                        <h3 class="jmy_web_div" data-page="TEMAZCAL" id="subtitulo_temazcal" data-editor="no">
                <?php $this->pnt('subtitulo_temazcal','Temazcal  (mínimo 2 personas) '); ?>
                ...
                <?php $this->pnt('duracion_temazcal','Sesión de 1 hr (incluye)'); ?> 
                        ...
                        <ul  class="jmy_web_div" data-page="TEMAZCAL" id="costo_temazcal" data-editor="no">
                <?php $this->pnt('costo_temazcal','
                             <li>Mascarilla exfoliante</li>
                             <li>Mascarilla hidratante </li>
                             <li>Bebida purificante </li>'); ?> 
                            
                        </ul>
                        <h4 class="jmy_web_div" data-page="TEMAZCAL" id="masajes_temazcal" data-editor="no">
                <?php $this->pnt('masajes_temazcal','MASAJES'); ?> 
                            
                        </h4>
                        <ul class="jmy_web_div" data-page="TEMAZCAL" id="costo_temazcal" data-editor="no">
                <?php $this->pnt('costo_temazcal','
                             <li>$ 400 medio cuerpo</li>
                            <li>$ 500 cuerpo completo </li>'); ?> 
                           </ul>
                        ...
                        <ul>
                            ...
                            <div class="tooltip_styled tooltip-effect-4">
                                ...
                                <div class="tooltip-content jmy_web_div" data-page="TEMAZCAL" id="t_cama_temazcal" data-editor="no">
                <?php $this->pnt('t_cama_temazcal','Cama king size'); ?>
